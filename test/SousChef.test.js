...
const OneTwoThreeMasterChef = artifacts.require('OneTwoThreeMasterChef');
const SyrupBar = artifacts.require('SyrupBar');
const OneTwoThreeBonusChef = artifacts.require('OneTwoThreeBonusChef');
const MockBEP20 = artifacts.require('libs/MockBEP20');

contract('OneTwoThreeBonusChef', ([alice, bob, carol, dev, minter]) => {
  beforeEach(async () => {
    this.syrup = await MockBEP20.new('LPToken', 'LP1', '1000000', {
      from: minter,
    });
    this.chef = await OneTwoThreeBonusChef.new(this.syrup.address, '40', '300', '400', {
      from: minter,
    });
  });
  ...
  it('try syrup', async () => {
    ...
    this.chef = await OneTwoThreeMasterChef.new(
      this.cake.address,
      this.syrup.address,
      dev,
      '1000',
    ...
    this.chef2 = await OneTwoThreeBonusChef.new(this.syrup.address, '40', '600', '800', {
      from: minter,
    });
