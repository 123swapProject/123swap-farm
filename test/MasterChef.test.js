...
contract('OneTwoThreeMasterChef', ([alice, bob, carol, dev, minter]) => {
    beforeEach(async () => {
        ...
        this.chef = await OneTwoThreeMasterChef.new(this.cake.address, this.syrup.address, dev, '1000', '100', { from: minter });
